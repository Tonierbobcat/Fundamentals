package com.loficostudios.fundamentals.economy;

import com.loficostudios.fundamentals.FundamentalsPlugin;

import com.loficostudios.fundamentals.player.UserDoesNotExistException;
...
public class VaultEconomyProvider implements net.milkbowl.vault.economy.Economy {
    ...
    public VaultEconomyProvider(FundamentalsPlugin plugin) {
        this.plugin = plugin;
    }
