...
public class GuiIcon {
    ...
    private final LofiCoffeeCore plugin = LofiCoffeeCore.getInstance();
    ...
    public GuiIcon( @NotNull ItemStack item, @Nullable String id, @NotNull Consumer<Player> onClick) {
        clearKeys(item, id);
